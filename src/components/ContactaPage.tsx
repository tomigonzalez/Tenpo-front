...
const ContactaPage = () => {
  ...
  return (
    <div className="w-full  px-4 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center" data-aos="fade-in"
          >
    ...
    data-aos-delay={`${index * 100}`} // delay dinámico por elemento
    data-aos-duration="600" // duración de la animación
